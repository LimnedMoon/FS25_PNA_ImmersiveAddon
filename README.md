<img src="https://i.ibb.co/N24PMCgt/icon.png" alt="icon" border="0">
...
## Important:
#1: All Parameters and timings aswell as Intervalls should be adjusted to your preference in "modOptions.xml" file.
#
